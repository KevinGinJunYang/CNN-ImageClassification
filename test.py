...
def evaluate(test_batches):
    ...
    ******Please do not change this function******
    ...
    return model.evaluate_generator(test_batches)
...
if __name__ == '__main__':
    ...
    test_batches = datagenerator.flow_from_directory(test_data_dir, target_size=image_size, classes=['tomato', 'strawberry', 'cherry'], batch_size=32, class_mode='categorical',seed=SEED)
    ...
    loss, accuracy = evaluate(test_batches)
